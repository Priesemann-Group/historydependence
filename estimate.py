...
def parse_arguments(defined_tasks, defined_estimation_methods):
    ...
    if not isfile('{}/settings/default.yaml'.format(CODE_DIR)):
        utl.create_default_settings_file(CODE_DIR)

    # load default settings
    with open('{}/settings/default.yaml'.format(CODE_DIR), 'r') as default_settings_file:
