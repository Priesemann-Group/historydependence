...
def get_history_dependence(estimation_method,
    ...
    if estimation_method == "bbc":
        ...
        return sh.shuffling_estimator(symbol_counts,
                                      ...
                                      H_uncond,
                                      return_ais=return_ais)
    elif estimation_method == "shuffling_with_correction":
        return sh.shuffling_estimator_with_correction(symbol_counts,
                                      number_of_bins_d,
                                      H_uncond,
                                      return_ais=return_ais)
    elif estimation_method == "nsb":
        return bbc.nsb_estimator(symbol_counts,
                                 past_symbol_counts,
                                 alphabet_size,
                                 alphabet_size_past,
                                 H_uncond,
                                 return_ais=return_ais)
    elif estimation_method == "plugin":
        return bbc.plugin_estimator(symbol_counts,
                                 past_symbol_counts,
                                 alphabet_size,
                                 alphabet_size_past,
                                 H_uncond,
