...
# linear relation
r_retina, p_value_retina = pearsonr(R_tot_retina, CV_retina)
r_CA1, p_value_CA1 = pearsonr(R_tot_CA1, CV_CA1)
r_culture, p_value_culture = pearsonr(R_tot_culture, CV_culture)
r_V1, p_value_V1 = pearsonr(R_tot_V1, CV_V1)
print('Pearson')
...
# rank relation
r_retina, p_value_retina = spearmanr(R_tot_retina, CV_retina)
r_CA1, p_value_CA1 = spearmanr(R_tot_CA1, CV_CA1)
r_culture, p_value_culture = spearmanr(R_tot_culture, CV_culture)
r_V1, p_value_V1 = spearmanr(R_tot_V1, CV_V1)
print('Spearman')
print('retina: ', r_retina, p_value_retina)
print('CA1: ', r_CA1, p_value_CA1)
print('culture: ', r_culture, p_value_culture)
...
ax1.errorbar(x=[CV_culture_median], y=[R_tot_culture_median],  yerr=[[R_tot_culture_median-R_tot_culture_median_loCI], [R_tot_culture_median_hiCI-R_tot_culture_median]], xerr=[[CV_culture_median-CV_culture_median_loCI], [CV_culture_median_hiCI-CV_culture_median]], color=main_red, marker='v', markersize=6)

ax1.errorbar(x=[CV_retina_median], y=[R_tot_retina_median],  yerr=[[R_tot_retina_median-R_tot_retina_median_loCI], [R_tot_retina_median_hiCI-R_tot_retina_median]], xerr=[[CV_retina_median-CV_retina_median_loCI], [CV_retina_median_hiCI-CV_retina_median]], color='orange', marker='o', markersize=6)

ax1.errorbar(x=[CV_V1_median], y=[R_tot_V1_median],  yerr=[[R_tot_V1_median-R_tot_V1_median_loCI], [R_tot_V1_median_hiCI-R_tot_V1_median]], xerr=[[CV_V1_median-CV_V1_median_loCI], [CV_V1_median_hiCI-CV_V1_median]], color=green, marker='s', markersize=6)

ax1.errorbar(x=[CV_CA1_median], y=[R_tot_CA1_median],  yerr=[[R_tot_CA1_median-R_tot_CA1_median_loCI], [R_tot_CA1_median_hiCI-R_tot_CA1_median]], xerr=[[CV_CA1_median-CV_CA1_median_loCI], [CV_CA1_median_hiCI-CV_CA1_median]], color=main_blue, marker='D', markersize=6)

ax2.errorbar(x=[CV_culture_median], y=[tau_R_culture_median],  yerr=[[tau_R_culture_median-tau_R_culture_median_loCI], [tau_R_culture_median_hiCI-tau_R_culture_median]], xerr=[[CV_culture_median-CV_culture_median_loCI], [CV_culture_median_hiCI-CV_culture_median]], color=main_red, marker='v', markersize=6)

ax2.errorbar(x=[CV_retina_median], y=[tau_R_retina_median],  yerr=[[tau_R_retina_median-tau_R_retina_median_loCI], [tau_R_retina_median_hiCI-tau_R_retina_median]], xerr=[[CV_retina_median-CV_retina_median_loCI], [CV_retina_median_hiCI-CV_retina_median]], color='orange', marker='o', markersize=6)

ax2.errorbar(x=[CV_V1_median], y=[tau_R_V1_median],  yerr=[[tau_R_V1_median-tau_R_V1_median_loCI], [tau_R_V1_median_hiCI-tau_R_V1_median]], xerr=[[CV_V1_median-CV_V1_median_loCI], [CV_V1_median_hiCI-CV_V1_median]], color=green, marker='s', markersize=6)

ax2.errorbar(x=[CV_CA1_median], y=[tau_R_CA1_median],  yerr=[[tau_R_CA1_median-tau_R_CA1_median_loCI], [tau_R_CA1_median_hiCI-tau_R_CA1_median]], xerr=[[CV_CA1_median-CV_CA1_median_loCI], [CV_CA1_median_hiCI-CV_CA1_median]], color=main_blue, marker='D', markersize=6)

ax1.scatter(CV_culture, R_tot_culture,
           s=3, color=main_red, marker="v", alpha=0.5, zorder=2)
ax1.scatter(CV_retina, R_tot_retina,
           s=3, color='orange', marker="o", alpha=0.5, zorder=2)
ax1.scatter(CV_V1, R_tot_V1,
           s=3, color=green, marker="s", alpha=0.5, zorder=2)
ax1.scatter(CV_CA1, R_tot_CA1,
           s=3, color=main_blue, marker="s", alpha=0.5, zorder=2)

ax2.scatter(CV_culture, tau_R_culture,
           s=3, color=main_red, marker="v", alpha=0.5, zorder=2)
ax2.scatter(CV_retina, tau_R_retina,
           s=3, color='orange', marker="o", alpha=0.5, zorder=2)
ax2.scatter(CV_V1, tau_R_V1,
           s=3, color=green, marker="s", alpha=0.5, zorder=2)
ax2.scatter(CV_CA1, tau_R_CA1,
           s=3, color=main_blue, marker="s", alpha=0.5, zorder=2)
...
plt.savefig('%s/S14Fig_measures_vs_CV.pdf'%(PLOTTING_DIR),
