...
print('CA1: ', R_tot_CA1_median, tau_R_CA1_median)
print('retina: ', R_tot_retina_median, tau_R_retina_median)
print('culture: ', R_tot_culture_median, tau_R_culture_median)
print('V1: ', R_tot_V1_median, tau_R_V1_median)
...
plt.savefig('{}/Fig7_Rtot_vs_tau_R.pdf'.format(PLOTTING_DIR),
