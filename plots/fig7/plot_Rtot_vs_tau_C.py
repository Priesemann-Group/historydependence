...
T_0_ms = 10
if T_0_ms == 10:
    # short timescale which is neglected when computing the generalized timescale
    # Slightly below 0.01, because embeddings for analysis are computed for T = 0.00998, thus almost 0.01 but sligthtly below.
    T_0 = 0.00997
else:
    T_0 = T_0_ms/1000.
...
print('CA1: ', autocorrelation_time_CA1_median)
print('retina: ',  autocorrelation_time_retina_median)
print('culture: ', autocorrelation_time_culture_median)
print('V1: ',  autocorrelation_time_V1_median)
...
plt.savefig('%s/Fig7_Rtot_vs_tau_C.pdf'%(PLOTTING_DIR),
